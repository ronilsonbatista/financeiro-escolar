          ...
          {activeTab === 'overview' && (
            layoutMode === 'modern' ? (
              <DashboardModern
                ...
                suppliers={suppliers}
                onOpenExpenseForm={() => { setEditingTransaction(null); setIsExpenseFormOpen(true); }}
                onOpenIncomeForm={() => { setEditingTransaction(null); setIsIncomeFormOpen(true); }}
              ...
              <DashboardClassic
                cardsData={cardsData}
                payablesStats={payablesStats}
                monthlyEvolution={monthlyEvolution}
                categories={categories}
                processedExpenses={processedExpenses}
                latestExpenses={latestExpenses}
                quickFilter={quickFilter}
                showRevenueSummary={showRevenueSummary}
                setShowRevenueSummary={setShowRevenueSummary}
